			...
			<div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
				<a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
					<svg
						...
						fillRule="evenodd"
						clipRule="evenodd"
						className="fill-current mt-3 mr-2 text-gray-400"
					>
				...
				<p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-2.5 mt-4">
					Copyright © 2023 - All right reserved
				</p>
				<span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
					<a class="text-gray-500 mt-1" href="https://github.com/yashPundhir">
					...
					>
						<img className="w-9 h-9" src={insta} alt="Insta-Logo" />
					</a>
					<a
						class="ml-4 text-gray-500 mt-[3px]"
